...
Read-only companion CLI for [playwright-cli](https://github.com/microsoft/playwright-cli). Connects to a browser running a Godot web game and queries element positions and events emitted by the [gd-playwright](../emitter/) emitter addon.
